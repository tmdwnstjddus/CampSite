		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12 p-b-30">
					<form action="/camp/campWrite" method="post" enctype="multipart/form-data" id="writeForm">
						...
						<div class="box_form">
							...
							<div class="input">
								<input type="text" id="camp_name" min="1" maxlength="18" name="campName" placeholder="캠프명을 입력해주세요." required>
								<hr>
							</div>
						...
						<div class="box_form">
							...
							<div class="row">
								<ul class="check_list space ml-3">
									<li>
										<input type="radio" name="category" value="글램핑" id="glamping" required>
										<label for="glamping" class="ellip">글램핑</label>
									</li>
									<li>
										<input type="radio" name="category" value="숙소" id="room" required>
										<label for="room" class="ellip">숙소</label>
									</li>
									<li>
										<input type="radio" name="category" value="카라반" id="caravan" required>
