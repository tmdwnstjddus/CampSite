         ...
         <div class="wrap_header">
            ...
            <div class="wrap_menu">
               <nav class="menu">
                  <ul class="main_menu">
                     <li>
                        <a href="/camp/campList?category=all" style="font-size:17px;font-weight:bolder;">캠핑장 예약</a>
                     </li>

                     <li >
                        <a href="/product/productList?category=all" style="font-size:17px;font-weight:bolder;">캠핑장 용품</a>
                     </li>
                     <li>
                        <a href="/upload/tourist" style="font-size:17px;font-weight:bolder;">주변관광지</a>
                     </li> 
                     <li>
                        <a href="/qna/qna" style="font-size:17px;font-weight:bolder;">Q&A</a>
                     </li>                     
                  </ul>
               </nav>
            </div>
				...
				<c:otherwise>
					<div>                        
						<a href="#" onclick="openNav()" class="p-r-8">
						 ...
						 <span style="color: blue; font-weight:bolder;">${ loginuser.memberId }님</span> 환영합니다!</a>&nbsp;	</a>
					</div>
				</c:otherwise>
			</c:choose>
			</div>
